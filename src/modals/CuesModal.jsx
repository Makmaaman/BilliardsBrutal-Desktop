  ...
  return (
    <ModalShell
      ...
      footer={
        <div className="flex justify-between w-full items-center">
          <div className="text-xs text-emerald-200/80">Створіть довідник київ, щоб привʼязувати їх до гравців на столах.</div>
          <div className="flex gap-2">
            <button className="h-9 px-3 rounded-lg border border-emerald-500/40 text-emerald-100 hover:bg-emerald-800/40" onClick={addRow}>Додати кий</button>
    ...
    >
      <div className="max-h-[70vh] overflow-y-auto pr-1">
        <div className="grid grid-cols-12 text-xs font-medium text-emerald-200 px-2 mb-2">
        ...
        <div className="space-y-2">
          {rows.length === 0 && (
            <div className="text-sm text-emerald-200/70 px-2 py-3 bg-slate-800/40 rounded-xl border border-emerald-500/20">Поки що немає жодного кия. Натисніть <b>Додати кий</b>.</div>
          )}
